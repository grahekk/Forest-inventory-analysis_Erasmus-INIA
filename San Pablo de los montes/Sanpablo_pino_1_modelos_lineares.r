...
Sanpablo_pino %>% filter(PARCELA == 1, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod11,.)) -> var2_pred11
Sanpablo_pino %>% filter(PARCELA == 1, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod12,.)) -> var2_pred12
Sanpablo_pino %>% filter(PARCELA == 1, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod13,.)) -> var2_pred13

Sanpablo_pino %>% filter(PARCELA == 2, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod21,.)) -> var2_pred21
Sanpablo_pino %>% filter(PARCELA == 2, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod22,.)) -> var2_pred22
Sanpablo_pino %>% filter(PARCELA == 2, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod23,.)) -> var2_pred23

Sanpablo_pino %>% filter(PARCELA == 3, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod31,.)) -> var2_pred31
Sanpablo_pino %>% filter(PARCELA == 3, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod32,.)) -> var2_pred32
Sanpablo_pino %>% filter(PARCELA == 3, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod33,.)) -> var2_pred33

Sanpablo_pino %>% filter(PARCELA == 4, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod41,.)) -> var2_pred41
Sanpablo_pino %>% filter(PARCELA == 4, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod42,.)) -> var2_pred42
Sanpablo_pino %>% filter(PARCELA == 4, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod43,.)) -> var2_pred43

Sanpablo_pino %>% filter(PARCELA == 5, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod51,.)) -> var2_pred51
Sanpablo_pino %>% filter(PARCELA == 5, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod52,.)) -> var2_pred52
Sanpablo_pino %>% filter(PARCELA == 5, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod53,.)) -> var2_pred53

Sanpablo_pino %>% filter(PARCELA == 6, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod61,.)) -> var2_pred61
Sanpablo_pino %>% filter(PARCELA == 6, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod62,.)) -> var2_pred62
Sanpablo_pino %>% filter(PARCELA == 6, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod63,.)) -> var2_pred63

Sanpablo_pino %>% filter(PARCELA == 7, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod71,.)) -> var2_pred71
Sanpablo_pino %>% filter(PARCELA == 7, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod72,.)) -> var2_pred72
Sanpablo_pino %>% filter(PARCELA == 7, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod73,.)) -> var2_pred73

Sanpablo_pino %>% filter(PARCELA == 8, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod81,.)) -> var2_pred81
Sanpablo_pino %>% filter(PARCELA == 8, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod82,.)) -> var2_pred82
Sanpablo_pino %>% filter(PARCELA == 8, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod83,.)) -> var2_pred83

Sanpablo_pino %>% filter(PARCELA == 9, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod91,.)) -> var2_pred91
Sanpablo_pino %>% filter(PARCELA == 9, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod92,.)) -> var2_pred92
Sanpablo_pino %>% filter(PARCELA == 9, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod93,.)) -> var2_pred93
