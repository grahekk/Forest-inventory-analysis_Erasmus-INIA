...
Sanpablo_rebollo %>% filter(PARCELA == 1, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod11,.)) -> var4_pred11
Sanpablo_rebollo %>% filter(PARCELA == 1, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod12,.)) -> var4_pred12
Sanpablo_rebollo %>% filter(PARCELA == 1, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod13,.)) -> var4_pred13

Sanpablo_rebollo %>% filter(PARCELA == 2, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod21,.)) -> var4_pred21
Sanpablo_rebollo %>% filter(PARCELA == 2, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod22,.)) -> var4_pred22
Sanpablo_rebollo %>% filter(PARCELA == 2, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod23,.)) -> var4_pred23

Sanpablo_rebollo %>% filter(PARCELA == 3, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod31,.)) -> var4_pred31
Sanpablo_rebollo %>% filter(PARCELA == 3, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod32,.)) -> var4_pred32
Sanpablo_rebollo %>% filter(PARCELA == 3, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod33,.)) -> var4_pred33

Sanpablo_rebollo %>% filter(PARCELA == 4, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod41,.)) -> var4_pred41
Sanpablo_rebollo %>% filter(PARCELA == 4, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod42,.)) -> var4_pred42
Sanpablo_rebollo %>% filter(PARCELA == 4, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod43,.)) -> var4_pred43

Sanpablo_rebollo %>% filter(PARCELA == 5, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod51,.)) -> var4_pred51
Sanpablo_rebollo %>% filter(PARCELA == 5, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod52,.)) -> var4_pred52
Sanpablo_rebollo %>% filter(PARCELA == 5, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod53,.)) -> var4_pred53

Sanpablo_rebollo %>% filter(PARCELA == 6, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod61,.)) -> var4_pred61
Sanpablo_rebollo %>% filter(PARCELA == 6, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod62,.)) -> var4_pred62
Sanpablo_rebollo %>% filter(PARCELA == 6, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod63,.)) -> var4_pred63

Sanpablo_rebollo %>% filter(PARCELA == 7, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod71,.)) -> var4_pred71
Sanpablo_rebollo %>% filter(PARCELA == 7, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod72,.)) -> var4_pred72
Sanpablo_rebollo %>% filter(PARCELA == 7, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod73,.)) -> var4_pred73

Sanpablo_rebollo %>% filter(PARCELA == 8, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod81,.)) -> var4_pred81
Sanpablo_rebollo %>% filter(PARCELA == 8, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod82,.)) -> var4_pred82
Sanpablo_rebollo %>% filter(PARCELA == 8, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod83,.)) -> var4_pred83

Sanpablo_rebollo %>% filter(PARCELA == 9, INVENTARIO == 1) %>% mutate(Prediccion = predict(linMod91,.)) -> var4_pred91
Sanpablo_rebollo %>% filter(PARCELA == 9, INVENTARIO == 2) %>% mutate(Prediccion = predict(linMod92,.)) -> var4_pred92
Sanpablo_rebollo %>% filter(PARCELA == 9, INVENTARIO == 3) %>% mutate(Prediccion = predict(linMod93,.)) -> var4_pred93

#los partes de tabla que no son llenos con predicion
Sanpablo_rebollo %>% filter(PARCELA == 10, INVENTARIO == 2) %>% mutate(Prediccion = NA) -> var4_no_pred102
Sanpablo_rebollo %>% filter(PARCELA == 10, INVENTARIO == 3) %>% mutate(Prediccion = NA) -> var4_no_pred103
Sanpablo_rebollo %>% filter(PARCELA == 11) %>% mutate(Prediccion = NA) -> var4_no_pred11
