...
gda1 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==1) %>%  
...
gda2 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==2) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = `ALT - TOTAL`,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda3 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==3) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = `ALT - TOTAL`,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda4 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==4) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = `ALT - TOTAL`,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda5 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==5) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = `ALT - TOTAL`,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda6 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==6) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = `ALT - TOTAL`,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda7 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==7) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = `ALT - TOTAL`,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda8 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==8) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = `ALT - TOTAL`,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda9 <- Sanpablo_H_pred_rebollo %>% filter(PARCELA==9) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = `ALT - TOTAL`,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
