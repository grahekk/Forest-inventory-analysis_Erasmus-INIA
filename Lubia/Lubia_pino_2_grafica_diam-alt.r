...
gda1 <- Lubia_H_pred_pino %>% filter(PARCELA==1) %>%  
...
gda2 <- Lubia_H_pred_pino %>% filter(PARCELA==2) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = Altura_def,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda3 <- Lubia_H_pred_pino %>% filter(PARCELA==3) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = Altura_def,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda4 <- Lubia_H_pred_pino %>% filter(PARCELA==4) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = Altura_def,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda5 <- Lubia_H_pred_pino %>% filter(PARCELA==5) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = Altura_def,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda6 <- Lubia_H_pred_pino %>% filter(PARCELA==6) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = Altura_def,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda7 <- Lubia_H_pred_pino %>% filter(PARCELA==7) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = Altura_def,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda8 <- Lubia_H_pred_pino %>% filter(PARCELA==8) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = Altura_def,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
...
gda9 <- Lubia_H_pred_pino %>% filter(PARCELA==9) %>%  
  ggplot(aes(x = `DIAM MED`/10, 
             y = Altura_def,
             color=INVENTARIO))+
  stat_smooth(method = lm, 
